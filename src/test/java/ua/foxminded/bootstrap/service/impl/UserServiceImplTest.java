...
@DataJpaTest(includeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = {HandlerMappingIntrospector.class, UserRepository.class, UserService.class, WebSecurityConfiguration.class}))
